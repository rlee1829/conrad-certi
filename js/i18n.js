...
CertApp.i18n = (function () {
  ...
  var DICT = {
    ko: {
      ...
      'ov.colEndingAmt': 'Ending 금액', 'ov.colEndingQty': 'Ending 건수', 'ov.total': '합계 (Total)', 'ov.expiredNote': '※ 「만료→잡이익」은 Used에 이미 포함된 내역입니다 (별도로 빼지 마세요). 만료로 마감된 금액은 전액 잡이익(C)으로 계상됩니다.',
    ...
    en: {
      ...
      'ov.colEndingAmt': 'Ending Amt', 'ov.colEndingQty': 'Ending Qty', 'ov.total': 'Total', 'ov.expiredNote': 'Note: “Expiry→Misc” is already included in Used — do not subtract it again. Expiry write-offs post 100% to misc income (C).',
