...
CertApp.i18n = (function () {
  ...
  var DICT = {
    ko: {
      ...
      'mr.allTypes': '전체 유형', 'mr.period': '기간(계상일)', 'mr.count': '{n}건 (전체 {total}건 중)', 'mr.netBalance': '잡이익 순잔액', 'mr.empty': '잡이익 내역이 없습니다.',
      ...
      'ov.colExpAmt': '만료→잡이익 금액', 'ov.colExpQty': '만료→잡이익 건수', 'ov.colVoidAmt': 'Void/Refund 금액', 'ov.colVoidQty': 'Void/Refund 건수',
      'ov.colEndingAmt': 'Ending 금액', 'ov.colEndingQty': 'Ending 건수', 'ov.total': '합계 (Total)', 'ov.balanceNote': '※ 기초 + 발행 − 사용 − 취소/환불 = 기말 로 대사됩니다. 만료로 잡이익 전환된 금액은 사용(Used)에 포함되어 있으며, 기간별 잡이익 내역은 「마감 요약」에서 확인하세요.',
      'ov.viewInList': '증서목록에서 이 종류 전체 보기',
      'ov.grpOpening': 'Opening', 'ov.grpIssued': 'Issued', 'ov.grpUsed': 'Used', 'ov.grpExpired': '만료→잡이익 (Used 중)',
      ...
      'cl.bulkGrace.date': '사용일', 'cl.bulkGrace.notePlaceholder': '잡이익 원장에 남길 비고 (선택)',
    ...
    en: {
      ...
      'mr.allTypes': 'All Types', 'mr.period': 'Period (entry date)', 'mr.count': '{n} of {total}', 'mr.netBalance': 'Net Misc Income', 'mr.empty': 'No misc income entries.',
      ...
      'ov.colExpAmt': 'Expiry→Misc Amt', 'ov.colExpQty': 'Expiry→Misc Qty', 'ov.colVoidAmt': 'Void/Refund Amt', 'ov.colVoidQty': 'Void/Refund Qty',
      'ov.colEndingAmt': 'Ending Amt', 'ov.colEndingQty': 'Ending Qty', 'ov.total': 'Total', 'ov.balanceNote': 'Note: Opening + Issued − Used − Void/Refund = Ending. Expiry write-offs are included in Used; see 마감 요약 (Close Summary) for misc income by period.',
      'ov.viewInList': 'View all of this category in the certificate list',
      'ov.grpOpening': 'Opening', 'ov.grpIssued': 'Issued', 'ov.grpUsed': 'Used', 'ov.grpExpired': 'Expiry→Misc (within Used)',
      ...
      'cl.bulkGrace.date': 'Used Date', 'cl.bulkGrace.notePlaceholder': 'Note for the misc income ledger (optional)',
