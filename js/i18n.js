...
CertApp.i18n = (function () {
  ...
  var DICT = {
    ko: {
      ...
      'cl.col.detail': '서비스 포함내역', 'cl.col.billNo': '비고 (영수증번호/객실번호)', 'cl.col.discountReceipt': '비고2 (할인/현금영수증)',
    ...
    en: {
      ...
      'cl.col.detail': 'Detail', 'cl.col.billNo': 'Note (Bill No. / Room No.)', 'cl.col.discountReceipt': 'Note 2 (Discount / Cash Receipt)',
