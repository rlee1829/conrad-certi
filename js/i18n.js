...
CertApp.i18n = (function () {
  ...
  var DICT = {
    ko: {
      ...
      'help.status.expired_final': '유효기간 경과 (확정) — 발행 후 5년이 지나 Grace Use(만료 후 사용)가 불가능합니다.',
      'help.status.misc_reversible': '잡이익 전환 — 만료로 잡이익 처리됨. 발행 후 5년 이내라 고객이 찾아오면 Grace Use로 90%를 매출로 되돌릴 수 있습니다.',
      'help.status.misc_final': '잡이익 확정 — 되돌릴 수 없습니다. (Gift 상품권은 처음부터 확정, Service 상품권은 발행 5년 경과)',
      'help.status.grace': '만료 후 사용 (Grace Use) — 만료로 잡이익 처리됐던 금액의 90%를 매출로 환원했습니다.',
